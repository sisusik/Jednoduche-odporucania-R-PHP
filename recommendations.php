...
<div id="dolphincontainer">
  <div id="dolphinnav">
    <ul>
      <li><a href="http://localhost/recommendations.php" class="current"><span>Najpredavanejsie celkovo</span></a></li>
...
<br>
<br><br>
<form action="recommendations.php" method="get">
...
if (isset($_GET["search_cust"])) {
	...
	if(mysql_num_rows($sql)<1){
   		echo "Zákazník nie je prihlásený, odporúèame mu:";
		echo randomProducts();
}else{
...
$sql="SELECT product_id, COUNT(*) FROM `prod_rec` GROUP BY product_id ORDER BY COUNT(*) DESC LIMIT 5";
