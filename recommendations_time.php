...
<div id="dolphincontainer">
  <div id="dolphinnav">
    <ul>
      ...
      <li><a href="http://localhost/recommendations_time.php" class="current"><span>Najpredavanejsie v case</span></a></li>
...
<br>
<br><br>
<form action="recommendations_time.php" method="get">
...
<?php
function top5ProductsInTime() {
$sql="SELECT product_id, COUNT(*) FROM `prod_rec` where time BETWEEN '01.02.2013' AND '01.06.2013' GROUP BY product_id ORDER BY COUNT(*) DESC LIMIT 5";
if($result=mysql_query("$sql")){
while($record=mysql_fetch_array($result)){
echo ("<td>".$record['product_id']."</td>");
}
echo ("\t vyberame najvhodnejsie produkty");
}
else echo mysql_error();
}
