...
<div id="dolphincontainer">
  <div id="dolphinnav">
    <ul>
      ...
      <li><a href="http://localhost/recommendations_special.php" class="current"><span>Specialne akcie</span></a></li>
...
<br>
<br><br>
<form action="recommendations_special.php" method="get">
...
echo ("\t specialne vybrane produkty");
}
